        ...
        <div className='container d-flex flex-column flex-md-row mb-5' >
            ...
            <div className='bg-light shadow-md rounded text-center w-100 w-md-50 mt-5'>
                <ul className='space-y-3'>
                    <li className='d-flex gap-3' role='button'><ArrowDownToLine/><span><a className='text-dark' href="/normativa/ALUMNOS-2025.pdf" target='window'>Alumnos</a></span></li>
                    ...
                    <li className='d-flex gap-3' role='button'><ArrowDownToLine/><span><a className='text-dark' href="/normativa/ABANDERADOS-2025.pdf" target='window'>Abanderados</a></span></li>
